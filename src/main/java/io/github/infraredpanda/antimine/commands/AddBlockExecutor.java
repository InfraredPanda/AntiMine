...
public class AddBlockExecutor implements CommandExecutor
{
	public CommandResult execute(CommandSource src, CommandContext ctx) throws CommandException
	{
		if (src instanceof Player)
		{
			...
			if (optionalBlockType.isPresent())
			{
				...
				AntiMine.blockedBlockTypes.add(blockType);
				src.sendMessage(Text.of(TextColors.GREEN, "[AntiMine] Success! ", TextColors.YELLOW, "Added block."));
			}
			else
			{
