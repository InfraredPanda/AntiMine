...
public class AddItemExecutor implements CommandExecutor
{
	public CommandResult execute(CommandSource src, CommandContext ctx) throws CommandException
	{
		if (src instanceof Player)
		{
			...
			if (optionalItemType.isPresent())
			{
				...
				AntiMine.blockedItemTypes.add(itemType);
				src.sendMessage(Text.of(TextColors.GREEN, "[AntiMine] Success! ", TextColors.YELLOW, "Added item."));
			}
			else
			{
